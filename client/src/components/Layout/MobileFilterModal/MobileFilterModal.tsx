...
export default function MobileFilterModal({
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-40 cursor-default"
        onClick={onClose}
      ...
      {/* Modal */}
      <aside
        className="lg:hidden fixed inset-x-0 bottom-0 bg-slate-900 rounded-t-2xl shadow-2xl z-50 max-h-[85vh] flex flex-col animate-slide-up"
        role="dialog"
        aria-modal="true"
